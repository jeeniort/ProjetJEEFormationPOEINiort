			...
			<div class="carousel-inner" onclick="AfficherDetail()">
				<div id="1111" class="carousel-item active">
					<img class="d-block w-100"
						src="<%=request.getContextPath()%>/image/burger_avocat_bacon.jpg"
						alt="First slide">
				...
				<div id="2222" class="carousel-item">
					<img class="d-block w-100"
						src="<%=request.getContextPath()%>/image/cake_banane_chocolat.jpg"
						alt="Cake à la banane et pépites de chocolat">
					<div class="carousel-caption d-none d-md-block">
						<h5>Cake à la banane et pépites de chocolat</h5>
					</div>
				</div>
				<div id="333" class="carousel-item">
					<img class="d-block w-100"
						src="<%=request.getContextPath()%>/image/chiktaye_morue_guadeloupe.jpg"
						alt="Chiktaye de morue Guadeloupe">
					<div class="carousel-caption d-none d-md-block">
